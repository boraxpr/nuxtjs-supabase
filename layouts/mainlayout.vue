...
<template>
  ...
  >
    <div
      class="h-full px-7 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 border-solid border-gray-200 border"
    >
      <NuxtLink to="/"
        ><div class="pt-7 pb-4">
          <img src="assets/img/SphereLogo.png" /></div
      ></NuxtLink>

      <Divider class="w-full h-[1px] bg-slate-300"></Divider>
      <ul class="space-y-2 font-medium">
        <li>
          <div
            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
          >
            <p class="font-semibold text-orange-500 text-lg">Service</p>
          </div>
          <a
            href="#"
            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
        ...
        <div
          class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
        >
          <p class="font-semibold text-orange-500 text-lg">Setting</p>
        </div>
        <li>
          <a
            href="#"
