    ...
    <header>
      <div class="Container grid grid-cols-2 gap-4 mb-4 h-40">
        <div class="Container flex items-center">
          <div class="text-3xl">quotation</div>
        </div>
...
>
        <template #header>
          ...
          <Column header="Status">
            <template #body="quotation">
              <div class="card flex justify-content-center ">
                <Dropdown v-model="dropdownStatus[quotation.data.doc_num]" :options="statusoption" optionLabel="name" :placeholder="quotation.data.status" @change="updateStatus(quotation.data.doc_num)" class="w-full md:w-14rem bg-[#F17121]" />
              </div>
            </template>
          </Column>
          ...
          <Column header="Edit">
            <template #body="quotation">
              <!-- Edit button -->
              <Nuxt-link :to="`/quotationlist/${quotation.data.doc_num}`">
  ...
  try {
    ...
    quotation.value = quotationData.map(quotation => {
      ...
      return {
        ...
        customer_phone: customer ? customer.phone_number : 'Unknown Customer phone number',
        project_named: project ? project.project_name : 'Unknow Project name',
      };
    });
