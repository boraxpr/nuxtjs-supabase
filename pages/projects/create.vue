        ...
        <div class="p-6 border-2 shadow-md rounded-lg">
            <div class="grid grid-cols-2 gap-4">
                <div class="col-span-2">
                    ...
                    <div class="mt-2">
                        <InputText v-model="createProject.input.project_name" class="p-2.5 h-10 w-full border-gray-300 rounded-lg hover:border-[#f17121]"/>
                    </div>
                </div>
                <div>
                    <div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <InputNumber v-model="createProject.input.price" inputId="locale-user" :minFractionDigits="2" :pt="{ input: { root: { class: 'rounded-lg', } } }" class="h-10 w-full"/>
                    </div>
                </div>
                <div class="col-span-2">
                    <div>
                    ...
                    <div class="mt-2">
                      <textarea v-model="createProject.input.desc" class="p-2.5 h-20 w-full border-gray-300 rounded-lg hover:border-2"></textarea>
                    </div>
                </div>
                <div class="col-span-2">
                    <div>
